...
export function ConversationTabs() {
  ...
  // Auto-switch to preview tab when a served app is first detected
  useEffect(() => {
    if (activeHost && !hasAutoOpenedPreview) {
      ...
      <div className="relative">
        <button
          ...
          className={cn(
            ...
            "text-[#555] hover:text-[#9299AA] hover:bg-[#1e2028]",
          )}
