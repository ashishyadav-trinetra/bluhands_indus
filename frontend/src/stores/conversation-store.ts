...
interface ConversationState {
  ...
  hasAutoOpenedPreview: boolean; // Prevents re-triggering auto-open on every poll
  previewViewport: PreviewViewport; // Viewport mode for the preview panel
...
interface ConversationActions {
  ...
  setHasAutoOpenedPreview: (hasAutoOpenedPreview: boolean) => void;
...
export const useConversationStore = create<ConversationStore>()(
  devtools(
    (set) => ({
      ...
      setHasAutoOpenedPreview: (hasAutoOpenedPreview) =>
        set({ hasAutoOpenedPreview }, false, "setHasAutoOpenedPreview"),

      setPreviewViewport: (previewViewport) =>
        set({ previewViewport }, false, "setPreviewViewport"),

      refreshPreview: () =>
        set(
          (state) => ({ previewRefreshKey: state.previewRefreshKey + 1 }),
          false,
          "refreshPreview",
        ),
    }),
