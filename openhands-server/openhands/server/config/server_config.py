...
class ServerConfig(ServerConfigInterface):
    ...
    settings_store_class: str = (
        'openhands.app_server.settings.supabase_settings_store.SupabaseSettingsStore'
        if os.environ.get('SUPABASE_URL')
        else 'openhands.app_server.settings.file_settings_store.FileSettingsStore'
    )
    secret_store_class: str = (
        'openhands.app_server.secrets.supabase_secrets_store.SupabaseSecretsStore'
        if os.environ.get('SUPABASE_URL')
        else 'openhands.app_server.secrets.file_secrets_store.FileSecretsStore'
    )
    user_auth_class: str = (
