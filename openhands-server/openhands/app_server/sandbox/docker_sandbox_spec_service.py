    ...
    return [
        SandboxSpecInfo(
            ...
            initial_env={
                ...
                'PYTHONUNBUFFERED': '1',
                'ENV_LOG_LEVEL': '20',
                # Fix npm global install permissions for non-root user
                'NPM_CONFIG_PREFIX': '/home/openhands/.npm-global',
                'PATH': '/home/openhands/.npm-global/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin',
                **get_agent_server_env(),
            },
