...
from openhands.app_server.utils.agent_server_url import (
    to_internal_agent_server_url,
)
...
async def load_skills_from_agent_server(
    ...
    """
    try:
        # Talk to the agent-server directly on localhost (process/local runtime)
        # to avoid the self-signed reverse-proxy certificate.
        agent_server_url = to_internal_agent_server_url(agent_server_url)
        ...
        # Make API request
        _logger.info(f'DEBUG skill_loader URL: {agent_server_url}/api/skills')
